...
// Stubs for removed message-action-runner functionality
const runMessageAction = async (): Promise<null> => null;
const getToolResult = (): null => null;
...
function filterActionsForContext(params: {
  ...
  // No channel-specific filtering needed since built-in channels were removed
